...
\title{Documentation -- Hybridization Expansion CT-QMC solver\\ version 3.0}
\author{Emanuel Gull}
...
\item \verb#MEASURE_h2w#=\{0,1\} turns on the measurement of the three-particle correlator $H$ (see Sec.\ref{2particle}). Requires \verb#N_w2# and \verb#N_W#.
